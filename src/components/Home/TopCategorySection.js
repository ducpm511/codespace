    ...
    return (
        <div className="top-catagory-area pt-110 pb-90">
         <div className="container">
            <div className="row">
               <div className="col-xl-5 offset-xl-4 col-lg-6 offset-lg-3 col-md-12 col-sm justify-content-center mb-30">
                  <div className="section-title mb-20 text-center">
                     <h2>Lý do nên học Lập Trình tại <span className="down-mark-line">CodeSpace </span></h2>
                  </div>
               </div>
            </div>
            <div className="row">
                ...
                <Link href="/courses"><a>
                     <div className="catagory-wrapper mb-30">
                        ...
                        <div className="catagory-content">
                           ...
                           <span>Phát triển kỹ năng Khoa học, Kỹ thuật, Công nghệ, Nghệ thuật và Toán học</span>
                        </div>
                     </div>
                </a></Link>
               </div>
                    ...
                    <Link href="/course"><a>
                     <div className="catagory-wrapper mb-30">
                        ...
                        <div className="catagory-content">
                           ...
                           <span>Lĩnh hội kiến thức thông qua việc thực hành các dự án thực tế</span>
                        </div>
                     </div>
                     </a></Link>
               </div>
               <div className="col-xl-4 col-lg-6 col-md-6">
                  <Link href="/course"><a>
                     <div className="catagory-wrapper mb-30">
                        ...
                        <div className="catagory-content">
                           <h3>Tăng khả năng ứng dụng</h3>
                           <span>Kiến thức được học có thể sử dụng ngay trong cuộc sống</span>
                        </div>
                     </div>
                    </a></Link>
               </div>
                    ...
                    <Link href="/course"><a>
                     <div className="catagory-wrapper mb-30">
                        ...
                        <div className="catagory-content">
                           ...
                           <span>Kích thích óc sáng tạo, và khả năng tư duy logic</span>
                        </div>
                     </div>
                     </a></Link>
               </div>
               <div className="col-xl-4 col-lg-6 col-md-6">
                    <Link href="/course"><a>
                     <div className="catagory-wrapper mb-30">
                        ...
                        <div className="catagory-content">
                           <h3>Học mà chơi</h3>
                           <span>Không áp lực điểm số và thi cử</span>
                        </div>
                     </div>
                     </a></Link>
               </div>
               <div className="col-xl-4 col-lg-6 col-md-6">
                    <Link href="/course"><a>
                     <div className="catagory-wrapper mb-30">
                        ...
                        <div className="catagory-content">
                           <h3>Học cùng chuyên gia</h3>
                           <span>CodeSpace tự hào với đội ngũ giàu kinh nghiệm trong lĩnh vực CNTT</span>
                        </div>
                     </div>
                    </a></Link>
               </div>
