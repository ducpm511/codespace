            ...
            <div className="row">
               <div className="col-12">
                  <div className="section-title text-center mb-60">
                     <h2>Đội ngũ của <span className="down-mark-line-2">CodeSpace</span></h2>
                  </div>
               </div>
               <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div className="features-box text-center mb-30">
                     ...
                     <div className="features-text">
                        <h4>Chuyên gia trong lĩnh vực</h4>
                        <p>Chúng tôi là tập thể gồm những lập trình viên, giáo viên giàu kinh nghiệm và kiến thức CNTT</p>
                     </div>
                  </div>
               </div>
               <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div className="features-box text-center mb-30">
                     ...
                     <div className="features-text">
                        <h4>Am hiểu thị trường</h4>
                        <p>Chúng tôi luôn nắm bắt xu thế về công nghệ và thị trường nhân lực trong ngành CNTT</p>
                     </div>
                  </div>
               </div>
               <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div className="features-box text-center mb-30">
                     <div className="features-svg">
                           <svg id="make" xmlns="http://www.w3.org/2000/svg" width="70.837" height="78.921" viewBox="0 0 45 45">
                     ...
                     <div className="features-text">
                        <h4>Sứ mệnh phát triển thế hệ trẻ</h4>
                        <p>Chúng tôi nhận thấy trách nhiệm của mình phát triển nền CNTT nước nhà thông qua dìu dắt thế hệ trẻ</p>
                     </div>
                  </div>
               </div>
            </div>
