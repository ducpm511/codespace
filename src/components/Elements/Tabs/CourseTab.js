                    ...
                    <div className="tab-content portfolio-tabs-content" id="nav-tabContent">
                        <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div className='row'>
                                ...
                                {
                                    allClasses && allClasses.map((course, idx) => {
                                        return (
                                                ...
                                                <div className="eduman-course-main-wrapper mb-30">
                                                    <div className="course-cart">
                                                        <div className="course-info-wrapper">
                                                            <div className="cart-info-body">
                                                                <span className="category-color category-color-1"><Link href="/khoa-hoc"><a>{course.details.language} </a></Link></span>
                                                    ...
                                                    <div className="eduman-course-wraper">
                                                        <div className="eduman-course-heading">
                                                            <Link href="/khoa-hoc"><a className="course-link-color-1">{course.details.language}</a></Link>
                        ...
                        <div className="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div className='row'>
                                {
                                    sixToEightClasses && sixToEightClasses.map((course, idx) => {
                                        return (
                                            <div className="col-xl-4 col-lg-4 col-md-6" key={idx}>
                                                <div className="eduman-course-main-wrapper mb-30">
                                                    <div className="course-cart">
                        ...
                        <div className="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <div className='row'>
                                {
                                    eightToFourteenClasses && eightToFourteenClasses.map((course, idx) => {
                                        return (
                                            <div className="col-xl-4 col-lg-4 col-md-6" key={idx}>
                                                <div className="eduman-course-main-wrapper mb-30">
                                                    <div className="course-cart">
                        ...
                        <div className="tab-pane fade" id="nav-contactA" role="tabpanel" aria-labelledby="nav-contact-tabA">
                            <div className='row'>
                                {
                                    thirdTeenToEightTeenClasses && thirdTeenToEightTeenClasses.map((course, idx) => {
                                        return (
                                            <div className="col-xl-4 col-lg-4 col-md-6" key={idx}>
                                                <div className="eduman-course-main-wrapper mb-30">
                                                    <div className="course-cart">
